<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="usersList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="微信unionid" align="center" prop="unionid" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.unionid" :width="50" :height="50"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="微信unionid" prop="unionid">
          <image-upload v-model="form.unionid"/>
        </el-form-item>
        <el-form-item label="用户昵称" prop="nickname">
        ...
        <el-form-item label="性别(数据字典)" prop="gender">
          <el-input v-model="form.gender" placeholder="请输入性别(数据字典)" />
        </el-form-item>
        <el-form-item label="国家" prop="country">
